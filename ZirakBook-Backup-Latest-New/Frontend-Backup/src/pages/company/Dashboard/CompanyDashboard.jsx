        ...
        <div className="company-dashboard">
            ...
            <div className="metrics-grid">
                ...
                <div className="metric-card">
                    ...
                    <div className="metric-icon" style={{ backgroundColor: "#e0e7ffff" }}>
            ...
            <div className="secondary-metrics-grid">
                ...
                <div className="secondary-card">
                    ...
                    <div className="secondary-icon App-text-primary">
                ...
                <div className="secondary-card">
                    ...
                    <div className="secondary-icon App-text-success">
                                    ...
                                    <div key={i} className="list-item">
                                        <div className="list-info">
                                            {p.image ? (
                                                ...
                                                <div className="list-img-placeholder"><Package size={20} color="#64748b" /></div>
                                            )}
                            ...
                            <div className="recent-list">
                                {stats.recentTransactions.map((tx, idx) => (
                                    <div key={idx} className="recent-item">
                                        ...
                                        <div className={`recent-amount ${tx.type === 'INCOME' || tx.type === 'SALES_INVOICE' ? 'App-text-success' : 'text-danger'}`}>
                                ...
                                {stats.topCustomers.map((c, i) => (
                                    <div key={i} className="list-item">
                                        <div className="list-info">
                                            ...
                                            <div className="list-img-placeholder" style={{ display: c.profileImage ? 'none' : 'flex' }}>
