    ...
    return (
        <div className="Voucher-voucher-page">
            <div className="Voucher-page-header">
                <h1 className="Voucher-page-title">Vouchers</h1>
                <button className="Voucher-btn-add" style={{ backgroundColor: '#8ce043' }} onClick={() => setShowAddModal(true)}>
                    <Plus size={18} />
                    Create Voucher
                </button>
            </div>
            ...
            <div className="Voucher-voucher-card">
                <div className="Voucher-controls-row">
                    <div className="Voucher-entries-control">
                        <select
                    ...
                    <div className="Voucher-search-control">
                        <input
                            type="text"
                            placeholder="Search..."
                            value={searchTerm}
                ...
                <div className="Voucher-pagination-row">
                    <p className="Voucher-pagination-info">Showing 1 to {vouchers.length} of {vouchers.length} entries</p>
                ...
                <div className="Voucher-modal-overlay">
                    <div className="Voucher-modal-content Voucher-voucher-modal">
                        <div className="Voucher-modal-header">
                            <h2 className="Voucher-modal-title">{showEditModal ? 'Edit Voucher' : 'Create Voucher'}</h2>
                            <button className="Voucher-close-btn" onClick={handleCloseModal}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="Voucher-modal-body">
                            <div className="Voucher-form-group Voucher-full-width">
                                <label className="Voucher-form-label">Voucher Type <span className="Voucher-text-red">*</span></label>
                                <select
                                    className="Voucher-form-input"
                            ...
                            {formData.voucherType === 'JOURNAL' ? (
                                ...
                                <>
                                    <div className="Voucher-voucher-header-top">
                                        <div className="Voucher-form-group" style={{ flex: 1 }}>
                                            <label className="Voucher-form-label">Company Name</label>
                                            <input
                                                type="text"
                                                className="Voucher-form-input"
                                        ...
                                        <div className="Voucher-logo-upload-area" onClick={handleLogoUpload}>
                                            {logo ? (
                                                <img src={logo} alt="Logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                                            ) : (
                                                <>
                                                    <Upload size={24} color="#94a3b8" />
                                                    <span className="Voucher-logo-upload-placeholder">LOGO<br />Click to upload</span>
                                                </>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="Voucher-form-grid">
                                        <div className="Voucher-form-group">
                                            <label className="Voucher-form-label">Paid From (Cash/Bank) <span className="Voucher-text-red">*</span></label>
                                            <select
                                                className="Voucher-form-input"
                                            ...
                                            <label className="Voucher-form-label">
                                                {formData.voucherType === 'INCOME' ? 'Paid To (Customer)' :
                                                    formData.voucherType === 'CONTRA' ? 'Paid To (Bank/Cash)' :
                                                        'Paid To (Vendor/Payable)'} <span className="Voucher-text-red">*</span>
                                            </label>
                                            <select
                                                className="Voucher-form-input"
                                                value={
                                    ...
                                    <div className="Voucher-form-grid">
                                        <div className="Voucher-form-group">
                                            <label className="Voucher-form-label">Warehouse</label>
                                            <select
                                                className="Voucher-form-input"
                                        ...
                                        <div className="Voucher-form-group">
                                            <label className="Voucher-form-label">Voucher Number</label>
                                            <input
                                                type="text"
                                                className="Voucher-form-input"
                                    ...
                                    <div className="Voucher-form-group Voucher-mb-4" style={{ maxWidth: '50%' }}>
                                        <label className="Voucher-form-label">Date <span className="Voucher-text-red">*</span></label>
                                        <input
                                            type="date"
                                            className="Voucher-form-input"
                                    ...
                                    <div className="Voucher-product-details-header">
                                        <h3 className="Voucher-product-details-title">Product Details</h3>
                                    </div>

                                    <div className="Voucher-table-container Voucher-thin-border">
                                        <table className="Voucher-voucher-items-table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                {items.map((item, index) => (
                                                    <tr key={item.id}>
                                                        <td>
                                                            <select
                                                                className="Voucher-form-input Voucher-input-sm"
                                                        ...
                                                        <td className="font-semibold Voucher-text-center">{formatCurrency(item.amount || 0)}</td>
                                                        <td>
                                                            <button className="Voucher-btn-delete-item" onClick={() => handleRemoveItem(item.id)}>
                                                                <Trash2 size={14} />
                                                            </button>
                                                        </td>
                                                    </tr>
                                    ...
                                    <button className="Voucher-btn-add-item-link" onClick={handleAddItem} style={{ color: '#8ce043', borderColor: '#8ce043' }}>
                                        + Add Item
                                    </button>

                                    <div className="Voucher-voucher-footer-grid">
                                        <div className="notes-section">
                                            <label className="Voucher-form-label">Notes</label>
                                            <textarea
                                                className="Voucher-form-input textarea"
                                                rows={4}
                                                placeholder="Notes"
                ...
                <div className="Voucher-modal-overlay">
                    <div className="Voucher-modal-content Voucher-voucher-modal">
                        <div className="Voucher-modal-header">
                            ...
                            <button className="Voucher-close-btn" onClick={() => setShowViewModal(false)}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="Voucher-modal-body">
