...
const ContraVoucher = () => {
    ...
    return (
        <div className="Contra-expenses-page">
            <div className="Contra-page-header">
                <div>
                    <h1 className="Contra-page-title">Contra Voucher</h1>
                </div>
                <button className="Contra-expenses-btn-success" onClick={() => { resetForm(); setSelectedContra(null); setIsCreateOpen(true); }}>
                    <Plus size={18} /> Create Voucher
                </button>
            </div>

            <div className="Contra-table-card">
                <div className="Contra-table-controls">
                ...
                <div className="table-responsive">
                    <table className="Contra-data-table">
                        <thead>
                            <tr>
                                <th>DATE</th>
                                <th>AUTO REF NO</th>
                                ...
                                contraVouchers.map((row) => (
                                    <tr key={row.id}>
                                        ...
                                        <td className="text-left">
                                            <div className="Contra-action-buttons1">
                                                <button className="Contra-expenses-btn-icon Contra-view" onClick={() => handleView(row)} title="View">
                                                    <Eye size={16} />
                                                </button>
                                                <button className="Contra-expenses-btn-icon Contra-edit" onClick={() => handleEdit(row)} title="Edit">
                                                    <Edit size={16} />
                                                </button>
                                                <button className="Contra-expenses-btn-icon Contra-delete" onClick={() => openDelete(row)} title="Delete">
                                                    <Trash2 size={16} />
                                                </button>
                                            </div>
                                        </td>
            ...
            {isViewOpen && selectedContra && (
                <div className="Contra-modal-overlay">
                    <div className="Contra-modal-content Contra-large-modal">
                        <div className="Contra-modal-header">
                            <h2>View Voucher Details</h2>
                            <button className="Contra-close-btn" onClick={() => setIsViewOpen(false)}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="Contra-modal-body">
                            <div className="Contra-form-row">
                                <div className="Contra-form-group Contra-half">
                            ...
                            <div className="Contra-items-table-wrapper mt-4">
                                <table className="Contra-items-table view-table">
                                    <thead>
                                        <tr>
                            ...
                            <div className="Contra-form-group mt-4">
                                <label>Main Narration</label>
                                <textarea rows="2" value={selectedContra.mainNarration || '-'} disabled className="bg-gray-100"></textarea>
                            </div>
                        </div>
                        <div className="Contra-modal-footer">
                            <button className="Contra-btn-cancel" onClick={() => setIsViewOpen(false)}>Close</button>
                            <button className="Contra-btn-save" onClick={() => { setIsViewOpen(false); handleEdit(selectedContra); }}>Edit</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="Contra-modal-overlay">
                    <div className="Contra-modal-content Contra-large-modal">
                        <div className="Contra-modal-header">
                            ...
                            <button className="Contra-close-btn" onClick={() => setIsCreateOpen(false)}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="Contra-modal-body">
                            ...
                            <div className="Contra-form-row">
                                <div className="Contra-form-group Contra-half">
                                    <label>Voucher Date<span className="Contra-required">*</span></label>
                                    <input
                                        type="date"
                                        value={formData.date}
                                ...
                                <div className="Contra-form-group Contra-half">
                                    <label>Paid From (Source/Credit)<span className="Contra-required">*</span></label>
                                    <select
                            ...
                            {/* Items Table */}
                            <div className="Contra-items-table-wrapper">
                                <table className="Contra-items-table">
                                    <thead>
                                        <tr>
                                        ...
                                        {formData.items.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="text-center">
                                                    <button className="Contra-expenses-btn-icon-red" onClick={() => handleRemoveItem(index)}>
                                                        <Trash size={14} />
                                                    </button>
                                                </td>
                                            </tr>
                                ...
                                <button className="Contra-btn-add-row" onClick={handleAddItem}>
                                    + Add Row
                                </button>
                            </div>
                        ...
                        <div className="Contra-modal-footer">
                            <button className="Contra-btn-cancel" onClick={() => setIsCreateOpen(false)}>Cancel</button>
                            <button className="Contra-btn-save" onClick={handleSave}>{selectedContra ? 'Update' : 'Save'}</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isDeleteOpen && (
                <div className="Contra-modal-overlay">
                    <div className="Contra-modal-content Contra-small-modal">
                        <div className="Contra-modal-header">
                            <h2>Delete Voucher</h2>
                            <button className="Contra-close-btn" onClick={() => setIsDeleteOpen(false)}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="Contra-modal-body">
                        ...
                        <div className="Contra-modal-footer">
                            <button className="Contra-btn-cancel" onClick={() => setIsDeleteOpen(false)}>Cancel</button>
                            <button className="Contra-btn-delete-confirm" onClick={handleDelete}>Delete</button>
                        </div>
                    </div>
                </div>
            )}
