            ...
            <div className="breakdown-grid">
                <div className="breakdown-card">
                    <div className="card-header">
                        ...
                        <span className="total-badge income">+{formatCurrency(summaryData.totalIncome)}</span>
                    </div>
                ...
                <div className="breakdown-card">
                    <div className="card-header">
                        ...
                        <span className="total-badge expense">-{formatCurrency(summaryData.totalExpense)}</span>
                    </div>
