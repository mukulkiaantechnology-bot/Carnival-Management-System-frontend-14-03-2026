                    ...
                    <div className="pd-value-column">
                        <div className="pd-value-card">
                            <div className="pd-value-header">
                                ...
                                <div className="pd-value-amt">{formatCurrency(itemValue)}</div>
                            </div>
                            <div className="pd-price-row">
                                <span className="pd-price-label">Sale Price:</span>
                                <div>
                                    <span className="pd-price-val">{formatCurrency(product.salePrice || 0)}</span>
                            ...
                            <div className="pd-price-row">
                                ...
                                <div>
                                    <span className="pd-price-val">{formatCurrency(product.purchasePrice || 0)}</span>
                                    <span className="pd-price-unit">/unit</span>
                                </div>
                            </div>
                        </div>
