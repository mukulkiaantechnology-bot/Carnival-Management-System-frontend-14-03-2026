...
const TopNavBar = () => {
  return (
    <div className="border-bottom py-2 px-3 px-md-5 App-bg-white top-navbar-wrapper">
      <Container fluid className="d-flex align-items-center justify-content-between">
        {/* Left: Logo */}
        <div className="d-flex align-items-center gap-2">
          <div className="fw-bold" style={{ fontSize: "18px", lineHeight: "1.2" }}>
            <img src={logo} alt="ZirakBook Logo" width="120" />
          </div>
        </div>
        ...
        <div className="d-none d-md-flex align-items-center gap-4 position-relative">
          ...
          <Dropdown className="support-dropdown">
            ...
            <Dropdown.Menu className="mt-2 App-shadow">
